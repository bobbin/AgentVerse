...
@SelectorRegistry.register("murdervillage")
class MurderVillageSelector(BaseSelector):
    """
    Selector for MurderVillage environment
    """

    def select_message(
        self, environment: MurderVillageEnvironment, messages: List[Message]
    ) -> List[Message]:
        valid = []
