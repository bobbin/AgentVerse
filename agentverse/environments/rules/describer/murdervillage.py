...
if TYPE_CHECKING:
    from agentverse.environments.murdervillage import MurderVillageEnvironment


@DescriberRegistry.register("murdervillage")
class MurderVillageDescriber(BaseDescriber):
    def get_env_description(
        self,
        environment: MurderVillageEnvironment,
        player_content: str = "",
    ) -> List[str]:
