...
@EnvironmentRegistry.register("murdervillage")
class MurderVillageEnvironment(BaseEnvironment):
    """
    An environment for Murder Village.
    ...
    async def _respond_to_player(
        ...
        player_message = Message(
            sender="Brendan", content=player_content, receiver=[agent_name]
        )
